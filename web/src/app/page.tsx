    ...
    <div className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14 w-full flex flex-col justify-between">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-20 pt-14 border-t border-slate-200">
        ...
        <div className="p-6 rounded-2xl bg-white/70 border border-slate-200/70 shadow-xs">
          ...
          <p className="text-xs text-slate-500 leading-relaxed">
            Uploaded and converted files are automatically deleted after processing with zero data retention.
          </p>
        </div>
      ...
      <div id="faq" className="mt-20 pt-16 border-t border-slate-200">
        ...
        <div className="max-w-3xl mx-auto space-y-4">
          {[
            {
              q: 'How does document privacy and security work?',
              a: 'Every file uploaded and generated by our workers is processed in isolated sandboxes and automatically deleted after processing. We never store, inspect, or retain your documents.',
            },
            {
